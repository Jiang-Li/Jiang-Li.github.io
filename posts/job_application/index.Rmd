---
title: "Analytics Job Application: Tips and Strategies"
...
- Search based on skills or Tools
...
**Note:** It's an easy way to see any Medium article for free. If you hit the Medium paywall, just open Twitter, go to your DMs, and DM yourself the link. Then click the link from your own DM, and you're in.
--

### Non-tech Questions

- [10 must-know interview questions](https://www.notion.so/7ba715c1a7044237b0b514d653813203?v=19ba91d66a7f4e389c4b2996445d74e0&p=f74d502561324f0c9138aec38b343d75&pm=s)
...
- What are the best programming languages and tools that can be used for Business Analytics? what kind of jobs do we need to apply for Business Analytics? How we need to prepare Resume for BA? Any best companies which have opportunities for Data Engineering or Data Analytics?

- How the job market gonna be in Analytics ? 2. What are the skill required for growth opportunities ?

- What skills do we need to get into full-time analytics job in google/Microsoft/Amazon ? What certification do we need before completion of course ? When we should start searching for the job ? How can we find the recruiters of Business analytics position ? Any sources or Leeds from university

- The skills required for job and is it possible to find s job in recession times.

- what do we actually get trained for jobs? Why analytics?

- I have an 2 years experience of business analyst back in India. I would like to now understand how to land on a data analysis job combining and utilizing my previous business analysis skills.

- When we get graduate what can we expect? Do we have any internships for analytics students? How can we do smart work and what extra programs or certifications need to be done ahead?
